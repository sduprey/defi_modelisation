...
lower_tick = get_tick(12.64)
upper_tick = get_tick(16.17)
lower_price = get_price(lower_tick)
upper_price = get_price(upper_tick)

base_threshold = upper_tick - lower_tick
print(f'base threshold {base_threshold}')
#https://etherscan.io/address/0x8209df5A847C321d26eCb155CA76f95224c5DCd9#readContract
ex_base_threshold = 3000
ex_limit_threshold = 3000/6
...
#    base_thresholds = range(500,5050,50)
#    plotHtml = False

    base_thresholds = [3000]
    plotHtml = True
