...
test_upper_adj_inv_price = from_tick_to_inv_adj_price(upper_tick, decimal0=decimals0, decimal1=decimals1)

test_lower_adj_price = from_tick_to_adj_price(lower_tick, decimal0=decimals0, decimal1=decimals1)
test_upper_adj_price = from_tick_to_adj_price(upper_tick, decimal0=decimals0, decimal1=decimals1)

test_back_tick = from_inv_adj_price_to_tick(test_lower_adj_inv_price, decimal0=decimals0, decimal1=decimals1)
test_back_tick_again = from_adj_price_to_tick(test_lower_adj_price, decimal0=decimals0, decimal1=decimals1)

assert lower_tick == test_back_tick

lower_tick_from_lower_bound = from_adj_price_to_tick(14.77, decimal0=decimals0, decimal1=decimals1)
upper_tick_from_lower_bound = from_adj_price_to_tick(16.17, decimal0=decimals0, decimal1=decimals1)

print('done')

def get_fork_spreading_factor_from_inv_price(lower_bound, upper_bound, decimal0=decimals0, decimal1=decimals1):
...
def get_fork_spreading_factor_from_price(lower_price, upper_price, decimal0=decimals0, decimal1=decimals1):
    upper_tick_from_upper_bound = from_adj_price_to_tick(lower_price, decimal0=decimals0, decimal1=decimals1)
    lower_tick_from_lower_bound = from_adj_price_to_tick(upper_price, decimal0=decimals0, decimal1=decimals1)
    sa = tick_to_price(lower_tick_from_lower_bound / 2)
    sb = tick_to_price(upper_tick_from_upper_bound / 2)
    return abs(sb-sa)


spreading_factor = get_fork_spreading_factor_from_price(14.77, 16.17, decimal0=decimals0, decimal1=decimals1)
